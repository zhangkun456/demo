                            ...
                            int outputFormat, int fileType, long channelMask)
{
    ...
    aufile->outputFormat = outputFormat;  // 1 == FAAD_FMT_16BIT

    aufile->samplerate = samplerate;  //44100
    aufile->channels = channels;  // 2
    aufile->total_samples = 0;
    aufile->fileType = fileType;  // 1 == OUTPUT_WAV
    aufile->channelMask = channelMask;  // 0
