...
/* ./.libs/lt-soundstretch.c - temporary wrapper executable for .libs/soundstretch
   Generated by libtool (GNU libtool) 2.4

   The soundstretch program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/usr/lib/gcc/i686-pc-cygwin/4.5.3:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/lib/gcc/i686-pc-cygwin/4.5.3:";
const char * TARGET_PROGRAM_NAME = "soundstretch"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# soundstretch - temporary wrapper script for .libs/soundstretch\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The soundstretch program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' /usr/lib/gcc/i686-pc-cygwin/4.5.3/libstdc++.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"soundstretch:soundstretch:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"soundstretch:soundstretch:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"soundstretch:soundstretch:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/usr/lib/gcc/i686-pc-cygwin/4.5.3:$PATH\n", f);
  fputs ("\n", f);
